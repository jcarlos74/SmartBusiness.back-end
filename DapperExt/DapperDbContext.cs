...
namespace DapperExt
{
    public class DapperDbContext : IDapperDbContext, IDisposable
    {
      ...
      //  public DapperDbContext(string connectionString, string schema = "siltec", string dataBaseDialect = "PostgreSQL", string dataBaseProvider = "Npgsql",int tenant = 0) //"Oracle.ManagedDataAccess.Client"
...

        {
            ...
            //if ( !DbProviderFactories.Exist(dataBaseProvider) )
            //{
