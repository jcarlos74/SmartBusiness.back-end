    ...
    public class AccessManagerService
    {
        ...
        public async Task<Token> GenerateToken(string emailUser,string ipAddress)
        {
            ...
            try
            {
                ...
                var identity = new ClaimsIdentity(claims, "SmartBusiness.Api");
                ...
                var result = new Token
                {
                    ...
                    UserInfo = new UserInfo() { IdUsuario = userIdentity.IdUsuario, IdTenant = userIdentity.IdTenant,UserName = userIdentity.NomeUsuario, Email = userIdentity.Email,Bloqueado = userIdentity.Bloqueado,IdColaborador =  userIdentity.IdColaborador},
                    Message = "OK"
                };
